...
namespace TextBasedRPG_OOP_WillB
{
    ...
    {
        //List<Enemy> enemyManager = new List<EnemyManager>();
        List<ItemManager> itemManager = new List<ItemManager>();
        Player player;
        HUD hud;
        Map map;
        //public Achievements(Player player, List<Enemy> enemy, List<ItemManager> itemManager, Map map)
        //{
        //    this.hud = new HUD(player, enemy, map);
